...
headline: 'If you haven''t started using Desmos, then you''re way behind the curve'
categories:
  - personal
  - math
  - teaching
...
In my next post I plan to describe how Desmos is transforming the way that math is taught and experienced in the college classroom. 
